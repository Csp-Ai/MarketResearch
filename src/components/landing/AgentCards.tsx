...
export default function AgentCards() {
  return (
    <section className="mt-24 pt-16 border-t border-gray-700 bg-gradient-to-b from-dark-800 via-dark-700 to-dark-900">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-dark-800 rounded-xl p-8 border border-gray-700 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 flex flex-col items-center">
            <img 
