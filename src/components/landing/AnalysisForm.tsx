...
export default function AnalysisForm({ 
  ...
  return (
    <div className="bg-dark-800 rounded-2xl p-8 border border-gray-700 shadow-2xl mb-12">
      ...
      {isAnalyzing && analysisLog.length > 0 && (
        <div className="bg-dark-700/50 backdrop-blur-sm rounded-xl p-4 border border-gray-600 mb-6">
